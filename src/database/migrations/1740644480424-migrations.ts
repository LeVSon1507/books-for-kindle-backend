...
export class Migrations1740644480424 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "emails" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "to" character varying NOT NULL, "cc" character varying, "bcc" character varying, "subject" character varying NOT NULL, "html" text NOT NULL, "sent" boolean NOT NULL DEFAULT false, "resendId" character varying, "error" json, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a54dcebef8d05dca7e839749571" PRIMARY KEY ("id"))`,
    );
  }
